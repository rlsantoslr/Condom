package br.com.condom.ui.dashboard
...
/*        binding.appBarDashboard.fab?.setOnClickListener { view ->
        ...
        binding.navView?.let {
            appBarConfiguration = AppBarConfiguration(
                setOf(
                    R.id.nav_main, R.id.nav_reflow, R.id.nav_slideshow, R.id.nav_settings
                ),
        ...
        binding.appBarDashboard.contentDashboard.bottomNavView?.let {
            appBarConfiguration = AppBarConfiguration(
                setOf(
                    R.id.nav_main, R.id.nav_reflow, R.id.nav_slideshow
                )
            )
            setupActionBarWithNavController(navController, appBarConfiguration)
            it.setupWithNavController(navController)
